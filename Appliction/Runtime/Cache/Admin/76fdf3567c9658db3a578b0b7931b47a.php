...
<div class="am-container">
    <div class="am-g">
        <div class="am-u-lg-6 am-u-lg-centered">
            <form class="am-form am-form-horizontal" action="/admin.php/User/updata" method="post">
                <h1 class="am-text-center">用户修改</h1>
                <input type="hidden" value="<?php echo ($row["id"]); ?>" />
                <div class="am-form-group">
                    <label for="doc-ipt-1" class="am-u-sm-3 am-form-label">用户名</label>
                    <div class="am-u-sm-8">
                        <input type="hidden" name="id" value="<?php echo ($row["id"]); ?>">
                        <input type="text" name="username" id="doc-ipt-1" value="<?php echo ($row["username"]); ?>" disabled>
                    </div>
                </div>
                <div class="am-form-group">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-8">
                        <input type="text" name="age" maxlength="3" id="doc-ipt-2" placeholder="<?php echo ($row["age"]); ?>">
                    </div>
                </div>
                <div class="am-form-group">
                    <label for="doc-ipt-3" class="am-u-sm-3 am-form-label">电话</label>
                    <div class="am-u-sm-8">
                        <input type="text" name="phone" maxlength="11" id="doc-ipt-3" placeholder="<?php echo ($row["phone"]); ?>">
                    </div>
                </div>
                <div class="am-form-group">
                    <label for="doc-ta-1" class="am-u-sm-3 am-form-label">联系地址</label>
                    <div class="am-u-sm-8">
                        <textarea name="address" rows="5" id="doc-ta-1" placeholder="<?php echo ($row["address"]); ?>"></textarea>
                    </div>
                </div>
                <div class="am-form-group">
                ...
                <div class="am-form-group">
                    <div class="am-u-sm-8 am-u-sm-offset-4">
                        <button type="submit" class="am-btn am-btn-primary hc-submit">修改</button>
...
<!--加载jq文件-->
<label class="am-checkbox-inline"><input type="checkbox" value="option1"></label>
